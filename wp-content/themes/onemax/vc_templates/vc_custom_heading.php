...
$text=str_replace('<p>', '<p '.$style.'>', $text);
...
if ( apply_filters( 'vc_custom_heading_template_use_wrapper', false ) ) {
	$output .= '<div class="' . esc_attr( $css_class ) . '" '.$aos.'>';
	$output .= '<' . $font_container_data['values']['tag'] . ' ' . $style . ' class="om-custom-head">';
	$output .= $text;
	$output .= '</' . $font_container_data['values']['tag'] . '>';
	$output .= '</div>';
} else {
	$output .= '<' . $font_container_data['values']['tag'] . ' ' . $style . ' class="' . esc_attr( $css_class ) . ' om-custom-head" '.$aos.'>';
	$output .= $text;
	$output .= '</' . $font_container_data['values']['tag'] . '>';
}
